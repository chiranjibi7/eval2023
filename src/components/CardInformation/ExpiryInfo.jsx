...
function ExpiryInfo() {
  ...
  return (
   <div className='w-full flex flex-col gap-4 md:gap-8'>
     <div className="w-full md:w-2/3 flex justify-between items-center bg-white p-2 md:p-5 md:text-xl">
     ...
     <input
     className="outline-none border-none rounded-xl bg-white p-3 w-1/2 md:p-6 md:text-xl"
     value={expiry} 
